    ...
    >
      <Flex
        ...
        _before={{
          ...
          height: "3px",
          background:
            "linear-gradient(90deg, var(--chakra-colors-brand-400), var(--chakra-colors-brand-600))",
          transform: "scaleX(0)",
                ...
                <Stack direction={{ base: "column", sm: "row" }} spacing={4}>
                  ...
                  <MotionBox
                    whileHover={{
                      ...
                      boxShadow:
                        "0 0 20px rgba(var(--chakra-colors-brand-500), 0.3)",
                    }}
                    whileTap={{ scale: 0.98 }}
                    transition={{ type: "spring", stiffness: 300, damping: 30 }}
                  >
                ...
                >
                  ...
                  <MotionBox
                    whileFocus={{
                      scale: 1.02,
                      boxShadow:
                        "0 0 30px rgba(var(--chakra-colors-brand-500), 0.2)",
                    }}
                    whileHover={{
