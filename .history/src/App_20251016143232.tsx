...
export function App() {
  return (
    <Routes>
      ...
      <Route path="/placeholder" element={<Layout><PlaceholderPage /></Layout>} />
      <Route path="/terms" element={<Layout><TermsPage /></Layout>} />
      <Route path="/privacy" element={<Layout><PrivacyPage /></Layout>} />
      <Route path="/lessons-demo" element={<Layout><LessonsDemoPage /></Layout>} />
      ...
      {/* AuthModal needs to be available globally */}
