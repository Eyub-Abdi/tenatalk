...
export function AuthModal() {
  ...
  const handleBasicRegister = () => {
    ...
    setTimeout(() => {
      ...
      if (isFormValid) {
        const isTutor = formRegister.user_type === "tutor";
        setAccountSubmitted(true);
        toast({
          title: "Account created successfully",
          description: isTutor
            ? "Basic account created. Log in to your dashboard to submit your tutor application."
                        ...
                        <FormControl isRequired>
                          ...
                          <Select
                            ...
                            onChange={(e) =>
                              setFormRegister((f) => ({
                                ...f,
                                user_type: e.target.value as "student" | "tutor",
                              }))
                            }
                          >
