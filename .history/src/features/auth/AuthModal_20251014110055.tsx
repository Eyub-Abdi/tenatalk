...
import { FiEye, FiEyeOff, FiMail, FiUser, FiGlobe, FiCheck, FiArrowRight, FiArrowLeft } from "react-icons/fi";
                  ...
                  {signupStep === 1 && (
                    ...
                    >
                      ...
                      <Box mb={6} p={4} bg="gray.50" borderRadius="lg" border="1px solid" borderColor="gray.200">
                        <FormLabel mb={3} fontSize="sm" fontWeight="medium">Password strength</FormLabel>
