...
export default function Overview() {
  ...
  const computeChecklist = useCallback((): ChecklistItem[] => {
    ...
    const teachingLanguages = Array.isArray(snapshot.teaching_languages)
      ...
      : [];
    const aboutMe =
      typeof snapshot.about_me === "string" ? snapshot.about_me : "";
    const teachingStyle =
    ...
    return [
      {
        ...
        action: {
          label: teachingLanguages.length ? "Manage" : "Add",
      ...
      },
      {
        ...
        action: {
          label: teachingStyle ? "Edit" : "Describe",
          to: "/teacher-application",
        },
      },
      {
        ...
        action: {
          label: interests.length ? "Manage" : "Pick",
          to: "/teacher-application",
        },
      },
      {
      ...
      <SimpleGrid columns={{ base: 1, xl: 2 }} spacing={6}>
        ...
        >
          <Stack spacing={4}>
            ...
            <Box>
              <Progress
                value={completionMetrics.percent}
                colorScheme="brand"
                borderRadius="full"
              />
              <HStack
          ...
          <Stack spacing={4}>
            ...
            <HStack spacing={2} align="center">
              <Icon
                as={FiTrendingUp}
                color={
                  earningsSummary.changePercent >= 0 ? "green.500" : "red.500"
                }
              />
              <Badge
                colorScheme={
                  earningsSummary.changePercent >= 0 ? "green" : "red"
                }
              >
