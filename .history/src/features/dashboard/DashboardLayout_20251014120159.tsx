...
export function DashboardLayout() {
  ...
  // Temporarily disabled auth guard for development - APIs not integrated yet
  // TODO: Re-enable when backend APIs are ready
  /*
  useEffect(() => {
    if (!isAuthenticated) {
      navigate("/", { replace: true, state: { from: location } });
      // small defer to ensure modal opens after navigation
      setTimeout(() => openLogin(), 0);
    }
  }, [isAuthenticated, navigate, location, openLogin]);
