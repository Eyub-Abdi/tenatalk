...
export default function Bookings() {
  ...
  const stats = useMemo(() => {
    ...
    return { upcoming, attention, completedThisWeek, nextLesson };
  ...
  const filters = useMemo(
    () => [
      ...
      { label: "Past", value: "past" as const, count: stats.completedThisWeek },
      { label: "All", value: "all" as const, count: bookings.length },
    ],
    [bookings.length, stats.attention, stats.completedThisWeek, stats.upcoming]
  );
